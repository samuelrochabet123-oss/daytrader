...
# ==============================================================================
# LÓGICA DO BOT (DAY TRADE SNIPER)
# ==============================================================================
def add_log(msg):
                ...
                if bot_state == "ACOMPANHANDO":
                    ...
                    if len(history_numbers) >= 3:
                        ...
                        if soma_3 <= 4:
                            ...
                            add_log(f"Motivo: Duplo Teto detectado ({prev_num} e {last_num})")
                        ...
                        if sinal_disparado:
                            ...
                            add_log("⚪ AGUARDANDO... Nenhum padrão numérico ativo.")
...
<head>
    ...
    <style>
        :root {
            --bg-main: #080a0f; --bg-card: rgba(22, 27, 34, 0.7); --border: rgba(255, 255, 255, 0.08);
            --text: #e6edf3; --text-muted: #7d8590; --purple: #bc52ff; --green: #00e676; --red: #ff5252; --yellow: #ffca28;
        }
    ...
    <div class="container">
        ...
        <div class="console" id="consoleBox">
            {% for line in logs %}
                ...
                {% elif 'GALE' in line or 'ACOMPANHANDO' in line %}
